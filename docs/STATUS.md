...
**Lote 3 — Tasks 3.1/3.3 (motor + front), 3.2, 3.4, 3.5 (motor + front), 3.6, 3.7, 3.8 (back + front), 3.10–3.11 (motor), 3.13 (catálogo-back) e 3.13 (catálogo-front) mescladas (13/~14)**:
