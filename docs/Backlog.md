...
| 3.6 | Cálculo de rolos de fita a comprar, a partir do tamanho de rolo cadastrado no catálogo (campo `produto.especificacao`, nunca hardcoded) | 🟡 LACUNA | ✅ Desbloqueada (Task 3.5 motor mesclada) | motor-engineer | Sonnet | Modelo 11.4 (A-12), 11.5; PRD RF-29, 10.4 |
